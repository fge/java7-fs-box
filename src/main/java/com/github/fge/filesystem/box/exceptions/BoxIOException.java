    ...
    extends IOException
{
     ...
     */
    public BoxIOException(final String message)
    {
        super(message);
    }
     ...
     * @since 1.6
     */
    public BoxIOException(final String message, final Throwable cause)
    {
        super(message, cause);
    }
     ...
     * @since 1.6
     */
    public BoxIOException(final Throwable cause)
    {
        super(cause);
    }
}
